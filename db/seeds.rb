...
jersey1 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-psg-home-2023-mbappe.jpg",
  user: user1,
  team: team1,
  size: "L",
  condition: "New"
...
jersey2 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-realmadrid-away-2023-benzema.jpg",
  user: user2,
  team: team2,
  size: "M",
  condition: "Used"
...
jersey3 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-liverpool-home-2023-salah.jpg",
  user: user3,
  team: team3,
  size: "XL",
  condition: "New"
...
jersey4 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-acmilan-home-2024-leao.jpg",
  user: user1,
  team: team4,
  size: "L",
  condition: "Used"
...
jersey5 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-mancity-home-2023-haaland.jpg",
  user: user2,
  team: team5,
  size: "M",
  condition: "New"
...
jersey6 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-bayernmunich-away-2023-muller.jpeg",
  user: user3,
  team: team6,
  size: "L",
  condition: "Used"
...
jersey7 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-barca-home-2023-lewandowski.jpg",
  user: user1,
  team: team7,
  size: "M",
  condition: "New"
...
jersey8 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-juventus-away-2023-vlahovic.jpg",
  user: user2,
  team: team8,
  size: "XL",
  condition: "Used"
...
jersey9 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-intermilan-home-2023-thuram.jpg",
  user: user3,
  team: team9,
  size: "L",
  condition: "New"
...
jersey10 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-chelsea-away-2023-sterling.jpg",
  user: user1,
  team: team10,
  size: "M",
  condition: "Used"
...
jersey11 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-psg-third-2023-neymar.jpg",
  user: user2,
  team: team1,
  size: "L",
  condition: "New"
...
jersey12 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-realmadrid-home-2023-vinicius.jpeg",
  user: user3,
  team: team2,
  size: "M",
  condition: "Used"
...
jersey13 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-liverpool-third-2023-virgil.jpg",
  user: user1,
  team: team3,
  size: "XL",
  condition: "New"
...
jersey14 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-acmilan-home-2023-tonali.jpg",
  user: user2,
  team: team4,
  size: "L",
  condition: "Used"
...
jersey15 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-mancity-third-2024-debruyne.jpg",
  user: user3,
  team: team5,
  size: "M",
  condition: "New"
...
jersey16 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-bayernmunich-home-2022-kimmich.jpg",
  user: user1,
  team: team6,
  size: "L",
  condition: "Used"
...
jersey17 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-barca-away-2023-pedri.jpg",
  user: user2,
  team: team7,
  size: "M",
  condition: "New"
...
jersey18 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-juventus-home-2023-chiesa.jpg",
  user: user3,
  team: team8,
  size: "XL",
  condition: "Used"
...
jersey19 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-intermilan-away-2023-lautaro.jpeg",
  user: user1,
  team: team9,
  size: "L",
  condition: "New"
...
jersey20 = Jersey.create!(
  ...
  image: "app/assets/images/jerseys/jersey-psg-home-2024-desiredoue.jpg",
  user: user2,
  team: team10,
  size: "M",
  condition: "Used"
